...
class GeopostPageBase(ProjectsBasePage):
    ...
    def verify_attribution_displayed(self):
        ...
        def condition(
            driver): return c not in attribution.get_attribute('class')
...
class GeopostEntryPage(GeopostPageBase):
    ...
    def verify_draw_active(self):
        ...
        def condition(driver): return (EntryLocators.ACTIVE in classStr and
    ...
    def verify_draw_not_active(self):
        ...
        def condition(driver): return (EntryLocators.ACTIVE not in classStr and
